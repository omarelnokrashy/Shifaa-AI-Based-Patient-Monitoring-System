...
BINARY_CKPT  = REPO_ROOT.parent.parent / "models" / "arrhythmia" / "binary_normal_abnormal" / "checkpoints" / "best.pt"
SUBTYPE_CKPT = REPO_ROOT.parent.parent / "models" / "arrhythmia" / "abnormal_subtype"       / "checkpoints" / "best.pt"
